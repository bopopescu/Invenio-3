/** Class providing an interface. The interface markup is create inside HTML,
  ...
  */
function FigureControlsArea(eventsBus, imageArea){
    /// data slots
...
FigureControlsArea.prototype.setFigure = function(newFigure){
    ...
    if (this.currentFigure != null && this.currentFigure != undefined){
	this.figurePreview.setImage(this.currentFigure.page.image);
	this.captionPreview.setImage(this.currentFigure.page.image);
...
FigureControlsArea.prototype.refreshInterface = function(){
	...
	image = this.currentFigure.page.image;
	captionImage = this.currentFigure.page.image;
	boundaryString = this.currentFigure.boundary.toString();
	captionBoundaryString = this.currentFigure.captionBoundary.toString();
	boundary = this.currentFigure.boundary;
	boundaryCaption = this.currentFigure.captionBoundary;
	figureAngle = this.currentFigure.boundary.angle;
	captionAngle = this.currentFigure.captionBoundary.angle;
    }
